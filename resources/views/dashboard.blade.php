        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <button class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                        <a href="{{ route('groups.sharedform') }}" class="text-white">Unirme a un grupo</a>
                    </button>
                </div>
                        ...
                        <tbody>
                            @foreach ($groups as $group)
                                ...
                                <tr class="border-none">
                                    <td class="border px-4 py-4 border-none"></td>
            ...
            <div class="p-6 text-gray-900 bg-white shadow-sm sm:rounded-lg">
                    <table class="table-auto w-full border-none border-collapse">
                        ...
                        <tbody>
                            @foreach ($groupsJoin as $shared)
                                <tr class="border-b-2 border-gray-200 items-center items-space-between">
                                    <td class="border px-4 py-2 border-none">{{ $shared->titulo }}</td>
                                    <td class="border px-4 py-2 border-none"><a href="{{ route('tasks.view', $shared->id) }}" class="text-blue-500 hover:bg-blue-700 hover:text-white border border-blue-500 p-2 rounded">ver tareas</a></td>
                                    <td class="border px-4 py-2 border-none"><a href="{{ route('tasks.create', $shared->id) }}" class="text-blue-500 hover:bg-blue-700 hover:text-white border border-blue-500 p-2 rounded">crear tarea</a></td>                                </tr>
                                <tr class="border-none">
                                    <td class="border px-4 py-4 border-none"></td>
                                    <td class="border px-4 py-2 border-none"></td>
                                    <td class="border px-4 py-2 border-none"></td>
